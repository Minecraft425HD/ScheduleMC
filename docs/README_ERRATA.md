...
|---|---|---|
| Client install JAR | `schedulemc-3.8.0-beta.jar` | `schedulemc-3.9.0-beta.jar` |
| “12 API modules” | 12 | **11** `I*API` interfaces |
...
`Version 3.8.0-beta | ~249k LOC across 1,561 Java files`
...
Any `ScheduleMC v3.8.0-beta` footer means **3.9.0-beta**.
