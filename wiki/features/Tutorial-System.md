...
> **STATUS: NOT IMPLEMENTED** - The Tutorial System described on this page was planned but has not been implemented in the current codebase. No tutorial-related code, commands, or manager classes exist in ScheduleMC v3.9.0-beta. This page is retained for reference as a design document for potential future implementation.
