 ...
 */
public class TemperingStationBlockEntity extends AbstractItemHandlerBlockEntity implements IUtilityConsumer, MenuProvider {
    ...
    private void createItemHandler() {
        itemHandler = new ItemStackHandler(2) {
            ...
            public boolean isItemValid(int slot, @NotNull ItemStack stack) {
                return slot == 0 && stack.getItem() == ChocolateItems.CONCHED_CHOCOLATE.get();
            }
    ...
    public void tick() {
        ...
        if (!inputStack.isEmpty() && outputStack.isEmpty()) {
            int prevProgress = temperingProgress;
            temperingProgress = Math.min(temperingProgress + (int) ticksPassed, PROCESSING_TIME);
            ...
            if (temperingProgress / 20 > prevProgress / 20) changed = true;
        }
