...
import de.rolandsw.schedulemc.chocolate.menu.LargeConchingMachineMenu;
...
public class LargeConchingMachineScreen extends AbstractContainerScreen<LargeConchingMachineMenu> {

    public LargeConchingMachineScreen(LargeConchingMachineMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.large_conching").getString(), x + 8, y + 6, 0xFFFFFF, false);
