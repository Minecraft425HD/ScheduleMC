...
import de.rolandsw.schedulemc.chocolate.menu.EnrobingMachineMenu;
...
public class EnrobingMachineScreen extends AbstractContainerScreen<EnrobingMachineMenu> {

    public EnrobingMachineScreen(EnrobingMachineMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.enrobing_machine").getString(), x + 8, y + 6, 0xFFFFFF, false);
