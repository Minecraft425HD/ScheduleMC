...
import de.rolandsw.schedulemc.chocolate.menu.TemperingStationMenu;
...
public class TemperingStationScreen extends AbstractContainerScreen<TemperingStationMenu> {

    public TemperingStationScreen(TemperingStationMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.tempering_station").getString(), x + 8, y + 6, 0xFFFFFF, false);
