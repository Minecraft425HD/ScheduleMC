...
import de.rolandsw.schedulemc.chocolate.menu.CoolingTunnelMenu;
...
public class CoolingTunnelScreen extends AbstractContainerScreen<CoolingTunnelMenu> {

    public CoolingTunnelScreen(CoolingTunnelMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.cooling_tunnel").getString(), x + 8, y + 6, 0xFFFFFF, false);
