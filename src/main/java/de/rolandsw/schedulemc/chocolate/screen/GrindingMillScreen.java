...
import de.rolandsw.schedulemc.chocolate.menu.GrindingMillMenu;
...
public class GrindingMillScreen extends AbstractContainerScreen<GrindingMillMenu> {

    public GrindingMillScreen(GrindingMillMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.grinding_mill").getString(), x + 8, y + 6, 0xFFFFFF, false);
