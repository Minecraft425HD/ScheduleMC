...
import de.rolandsw.schedulemc.chocolate.menu.WrappingStationMenu;
...
public class WrappingStationScreen extends AbstractContainerScreen<WrappingStationMenu> {

    public WrappingStationScreen(WrappingStationMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.wrapping_station").getString(), x + 8, y + 6, 0xFFFFFF, false);
