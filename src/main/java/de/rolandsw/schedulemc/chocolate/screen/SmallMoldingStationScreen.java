...
import de.rolandsw.schedulemc.chocolate.menu.SmallMoldingStationMenu;
...
public class SmallMoldingStationScreen extends AbstractContainerScreen<SmallMoldingStationMenu> {

    public SmallMoldingStationScreen(SmallMoldingStationMenu menu, Inventory playerInventory, Component title) {
