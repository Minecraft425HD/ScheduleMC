...
import de.rolandsw.schedulemc.chocolate.menu.SmallConchingMachineMenu;
...
public class SmallConchingMachineScreen extends AbstractContainerScreen<SmallConchingMachineMenu> {

    public SmallConchingMachineScreen(SmallConchingMachineMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.small_conching").getString(), x + 8, y + 6, 0xFFFFFF, false);
