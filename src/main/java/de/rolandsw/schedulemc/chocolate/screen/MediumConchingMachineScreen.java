...
import de.rolandsw.schedulemc.chocolate.menu.MediumConchingMachineMenu;
...
public class MediumConchingMachineScreen extends AbstractContainerScreen<MediumConchingMachineMenu> {

    public MediumConchingMachineScreen(MediumConchingMachineMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.medium_conching").getString(), x + 8, y + 6, 0xFFFFFF, false);
