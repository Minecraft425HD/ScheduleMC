...
import de.rolandsw.schedulemc.chocolate.menu.PressingStationMenu;
...
public class PressingStationScreen extends AbstractContainerScreen<PressingStationMenu> {

    public PressingStationScreen(PressingStationMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.pressing_station").getString(), x + 8, y + 6, 0xFFFFFF, false);
