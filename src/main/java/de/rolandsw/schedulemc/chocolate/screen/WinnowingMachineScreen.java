...
import de.rolandsw.schedulemc.chocolate.menu.WinnowingMachineMenu;
...
public class WinnowingMachineScreen extends AbstractContainerScreen<WinnowingMachineMenu> {

    public WinnowingMachineScreen(WinnowingMachineMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.chocolate.winnowing_machine").getString(), x + 8, y + 6, 0xFFFFFF, false);
