...
/**
 * Fügt dem Welt-erstellen-Screen einen Button hinzu, mit dem die Pro-Welt-Config-Vorlage
 * für NEUE Welten bearbeitet werden kann (über {@link DefaultConfigEditor}). So lässt sich
 * die Config schon vor der Welterstellung einstellen.
 */
