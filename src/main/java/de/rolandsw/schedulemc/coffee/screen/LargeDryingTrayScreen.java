...
/**
 * GUI für Large Coffee Drying Tray (30 Kirschen Kapazität)
 */
public class LargeDryingTrayScreen extends AbstractContainerScreen<LargeDryingTrayMenu> {

    public LargeDryingTrayScreen(LargeDryingTrayMenu menu, Inventory playerInventory, Component title) {
