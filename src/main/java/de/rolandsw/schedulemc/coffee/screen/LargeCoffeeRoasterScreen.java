...
/**
 * GUI für Large Coffee Roaster (64 Bohnen Kapazität)
 */
public class LargeCoffeeRoasterScreen extends AbstractContainerScreen<LargeCoffeeRoasterMenu> {

    public LargeCoffeeRoasterScreen(LargeCoffeeRoasterMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.coffee.large_roaster").getString(), x + 8, y + 6, 0xFFFFFF, false);

        // Kapazität
        graphics.drawString(this.font, Component.translatable("gui.coffee.capacity_beans", 64).getString(), x + 8, y + 22, 0xCCCCCC, false);
