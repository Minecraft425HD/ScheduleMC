...
/**
 * GUI für Medium Coffee Drying Tray (20 Kirschen Kapazität)
 */
public class MediumDryingTrayScreen extends AbstractContainerScreen<MediumDryingTrayMenu> {

    public MediumDryingTrayScreen(MediumDryingTrayMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (maxProgress > 0 && progress > 0) {
            ...
            graphics.fill(x + 76, y + 35, x + 76 + progressWidth, y + 51, 0xFFD2691E);
        }
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.coffee.medium_drying_tray").getString(), x + 8, y + 6, 0xFFFFFF, false);

        // Kapazität
        graphics.drawString(this.font, Component.translatable("gui.coffee.capacity_cherries", 20).getString(), x + 8, y + 22, 0xCCCCCC, false);
