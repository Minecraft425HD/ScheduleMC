...
public class MediumDryingTrayScreen extends AbstractContainerScreen<MediumDryingTrayMenu> {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, "Mittlere Kaffee-Trocknungsschale", x + 8, y + 6, 0xFFFFFF, false);

        // Kapazität
        graphics.drawString(this.font, "Max: 20 Kirschen", x + 8, y + 22, 0xCCCCCC, false);
