...
/**
 * GUI für Small Coffee Drying Tray (10 Kirschen Kapazität)
 */
public class SmallDryingTrayScreen extends AbstractContainerScreen<SmallDryingTrayMenu> {

    public SmallDryingTrayScreen(SmallDryingTrayMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.coffee.small_drying_tray").getString(), x + 8, y + 6, 0xFFFFFF, false);

        // Kapazität
        graphics.drawString(this.font, Component.translatable("gui.coffee.capacity_cherries", 10).getString(), x + 8, y + 22, 0xCCCCCC, false);
