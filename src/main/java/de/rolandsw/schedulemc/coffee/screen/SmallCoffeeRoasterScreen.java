...
public class SmallCoffeeRoasterScreen extends AbstractContainerScreen<SmallCoffeeRoasterMenu> {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.coffee.small_roaster").getString(), x + 8, y + 6, 0xFFFFFF, false);

        // Kapazität
        graphics.drawString(this.font, Component.translatable("gui.coffee.capacity_beans", 16).getString(), x + 8, y + 22, 0xCCCCCC, false);
