...
public class LargeBrewKettleScreen extends AbstractContainerScreen<LargeBrewKettleMenu> {

    public LargeBrewKettleScreen(LargeBrewKettleMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.beer.large_brew_kettle").getString(), x + 8, y + 6, 0xFFFFFF, false);
