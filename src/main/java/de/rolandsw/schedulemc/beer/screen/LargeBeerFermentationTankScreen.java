...
public class LargeBeerFermentationTankScreen extends AbstractContainerScreen<LargeBeerFermentationTankMenu> {

    public LargeBeerFermentationTankScreen(LargeBeerFermentationTankMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.beer.large_fermentation_tank").getString(), x + 8, y + 6, 0xFFFFFF, false);
