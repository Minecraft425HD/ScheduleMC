...
public class MaltingStationScreen extends AbstractContainerScreen<MaltingStationMenu> {

    public MaltingStationScreen(MaltingStationMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.beer.malting_station").getString(), x + 8, y + 6, 0xFFFFFF, false);
