...
public class SmallConditioningTankScreen extends AbstractContainerScreen<SmallConditioningTankMenu> {

    public SmallConditioningTankScreen(SmallConditioningTankMenu menu, Inventory playerInventory, Component title) {
