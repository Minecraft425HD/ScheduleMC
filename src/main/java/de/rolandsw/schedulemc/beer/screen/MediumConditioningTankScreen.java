...
import de.rolandsw.schedulemc.beer.menu.MediumConditioningTankMenu;
...
public class MediumConditioningTankScreen extends AbstractContainerScreen<MediumConditioningTankMenu> {

    public MediumConditioningTankScreen(MediumConditioningTankMenu menu, Inventory playerInventory, Component title) {
