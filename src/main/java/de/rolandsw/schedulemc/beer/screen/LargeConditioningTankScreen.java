...
public class LargeConditioningTankScreen extends AbstractContainerScreen<LargeConditioningTankMenu> {

    public LargeConditioningTankScreen(LargeConditioningTankMenu menu, Inventory playerInventory, Component title) {
