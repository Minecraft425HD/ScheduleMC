package de.rolandsw.schedulemc.beer.screen;
...
public class BottlingStationScreen extends AbstractContainerScreen<BottlingStationMenu> {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        drawSlot(graphics, x + 44, y + 35);  // Beer input slot
        drawSlot(graphics, x + 68, y + 35);  // Container input slot
        ...
        if (maxProgress > 0) {
            ...
            if (progressWidth > 0) {
                graphics.fill(x + 88, y + 35, x + 88 + progressWidth, y + 51, 0xFFC57F00); // Beer amber/golden color
            }
        }
