...
public class MediumBeerFermentationTankScreen extends AbstractContainerScreen<MediumBeerFermentationTankMenu> {

    public MediumBeerFermentationTankScreen(MediumBeerFermentationTankMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.beer.medium_fermentation_tank").getString(), x + 8, y + 6, 0xFFFFFF, false);
        ...
        if (progress > 0 && maxProgress > 0) {
            ...
            graphics.drawString(this.font, Component.translatable("gui.progress_percent", percent).getString(), x + 80, y + 56, 0xC57F00, false);
        }
    }
