...
public class MediumBrewKettleScreen extends AbstractContainerScreen<MediumBrewKettleMenu> {

    public MediumBrewKettleScreen(MediumBrewKettleMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.beer.medium_brew_kettle").getString(), x + 8, y + 6, 0xFFFFFF, false);
