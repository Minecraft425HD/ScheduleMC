...
public class ModItems {
    ...
    public static final RegistryObject<ItemVehiclePart> PERFORMANCE_2_MOTOR = ITEM_REGISTER.register("industrial_motor", () -> new ItemVehiclePart(PartRegistry.PERFORMANCE_2_MOTOR));
