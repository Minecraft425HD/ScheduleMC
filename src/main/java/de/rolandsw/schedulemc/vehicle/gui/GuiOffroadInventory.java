...
/**
 * GUI for Offroad vehicle inventory - 6 internal slots
 */
public class GuiOffroadInventory extends ScreenBase<ContainerOffroadInventory> {
    ...
    public GuiOffroadInventory(ContainerOffroadInventory container, Inventory playerInventory, Component title) {
