...
/**
 * GUI for Limousine vehicle inventory - 4 internal slots
 */
public class GuiLimousineInventory extends ScreenBase<ContainerLimousineInventory> {
    ...
    public GuiLimousineInventory(ContainerLimousineInventory container, Inventory playerInventory, Component title) {
