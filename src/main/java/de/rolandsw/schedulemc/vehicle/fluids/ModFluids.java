...
public class ModFluids {
    ...
    public static final RegistryObject<FluidType> BIO_DIESEL_TYPE = FLUID_TYPE_REGISTER.register("diesel", () ->
            new FluidTypeVehicle("fluid.schedulemc.diesel", ResourceLocation.fromNamespaceAndPath(Main.MODID, "block/diesel_still"), ResourceLocation.fromNamespaceAndPath(Main.MODID, "block/diesel_flowing"))
    );
