...
public class FluidTypeVehicle extends FluidType {

    private final ResourceLocation stillTexture;
    private final ResourceLocation flowingTexture;

    public FluidTypeVehicle(String descriptionId, ResourceLocation stillTexture, ResourceLocation flowingTexture) {
