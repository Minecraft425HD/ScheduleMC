...
public class HashPressScreen extends AbstractContainerScreen<HashPressMenu> {
    ...
    public HashPressScreen(HashPressMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (!menu.isPressing() && !menu.hasOutput() && menu.getTrimWeight() < de.rolandsw.schedulemc.cannabis.blockentity.HashPressBlockEntity.MIN_TRIM_WEIGHT) {
            String warn = String.format(Component.translatable("gui.hash_presse.hint_min_trim").getString(),
                    de.rolandsw.schedulemc.cannabis.blockentity.HashPressBlockEntity.MIN_TRIM_WEIGHT);
