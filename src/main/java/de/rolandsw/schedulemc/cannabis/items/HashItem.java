...
public class HashItem extends Item {
    ...
    public Component getName(ItemStack stack) {
        return Component.literal("§6🟤 ")
            .append(Component.translatable("item.hash.name"));
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.cannabis.weight_label").append(Component.literal("§f" + (weight * stack.getCount()) + "g")));
