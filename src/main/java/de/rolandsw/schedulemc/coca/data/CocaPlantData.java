package de.rolandsw.schedulemc.coca.data;

import de.rolandsw.schedulemc.coca.CocaType;
import de.rolandsw.schedulemc.tobacco.TobaccoQuality;

/**
 * Speichert Daten einer Koka-Pflanze
 */
public class CocaPlantData {

    private final CocaType type;
    ...
    public CocaPlantData(CocaType type) {
        this.type = type;
