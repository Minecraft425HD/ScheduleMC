 ...
 */
public class PillPressScreen extends AbstractContainerScreen<PillPressMenu> {
    ...
    public PillPressScreen(PillPressMenu menu, Inventory playerInventory, Component title) {
