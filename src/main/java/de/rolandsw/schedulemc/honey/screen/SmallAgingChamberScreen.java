...
public class SmallAgingChamberScreen extends AbstractContainerScreen<SmallAgingChamberMenu> {

    public SmallAgingChamberScreen(SmallAgingChamberMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        // 4 slots in 2x2 grid
        drawSlot(graphics, x + 62, y + 26);
        drawSlot(graphics, x + 80, y + 26);
        drawSlot(graphics, x + 62, y + 44);
        drawSlot(graphics, x + 80, y + 44);
