...
public class MediumAgingChamberScreen extends AbstractContainerScreen<MediumAgingChamberMenu> {

    public MediumAgingChamberScreen(MediumAgingChamberMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                drawSlot(graphics, x + 44 + j * 18, y + 17 + i * 18);
            }
        }
