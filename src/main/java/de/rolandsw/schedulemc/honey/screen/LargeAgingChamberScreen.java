...
public class LargeAgingChamberScreen extends AbstractContainerScreen<LargeAgingChamberMenu> {

    public LargeAgingChamberScreen(LargeAgingChamberMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                drawSlot(graphics, x + 35 + j * 18, y + 8 + i * 18);
            }
        }
