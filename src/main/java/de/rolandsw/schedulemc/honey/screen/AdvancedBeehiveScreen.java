...
public class AdvancedBeehiveScreen extends AbstractContainerScreen<AdvancedBeehiveMenu> {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.honey.advanced_beehive").getString(), x + 8, y + 6, 0xFFFFFF, false);
        ...
        if (progress > 0 && maxProgress > 0) {
            ...
            graphics.drawString(this.font, Component.translatable("gui.progress_percent", percent).getString(), x + 84, y + 56, 0xFFFFAA00, false);
        }
    }
