...
public class ApiaryScreen extends AbstractContainerScreen<ApiaryMenu> {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        // Two output slots
        drawSlot(graphics, x + 62, y + 35);
        drawSlot(graphics, x + 98, y + 35);
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.honey.apiary").getString(), x + 8, y + 6, 0xFFFFFF, false);
        ...
        if (progress > 0 && maxProgress > 0) {
            ...
            graphics.drawString(this.font, Component.translatable("gui.progress_percent", percent).getString(), x + 75, y + 56, 0xFFFFAA00, false);
        }
    }
