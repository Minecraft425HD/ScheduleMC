...
import de.rolandsw.schedulemc.cheese.menu.CurdlingVatMenu;
...
public class CurdlingVatScreen extends AbstractContainerScreen<CurdlingVatMenu> {
    public CurdlingVatScreen(CurdlingVatMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        // Slots
        drawSlot(graphics, x + 44, y + 35);  // Milk input
        drawSlot(graphics, x + 68, y + 35);  // Rennet input
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("block.schedulemc.curdling_vat"), x + 8, y + 6, 0xFFFFFF, false);
