...
import de.rolandsw.schedulemc.cheese.menu.MediumAgingCaveMenu;
...
public class MediumAgingCaveScreen extends AbstractContainerScreen<MediumAgingCaveMenu> {
    public MediumAgingCaveScreen(MediumAgingCaveMenu menu, Inventory playerInventory, Component title) {
