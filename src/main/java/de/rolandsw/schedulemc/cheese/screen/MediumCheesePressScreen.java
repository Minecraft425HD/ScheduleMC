...
import de.rolandsw.schedulemc.cheese.menu.MediumCheesePressMenu;
...
public class MediumCheesePressScreen extends AbstractContainerScreen<MediumCheesePressMenu> {
    public MediumCheesePressScreen(MediumCheesePressMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("block.schedulemc.medium_cheese_press"), x + 8, y + 6, 0xFFFFFF, false);
