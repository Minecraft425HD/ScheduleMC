...
import de.rolandsw.schedulemc.cheese.menu.LargeAgingCaveMenu;
...
public class LargeAgingCaveScreen extends AbstractContainerScreen<LargeAgingCaveMenu> {
    public LargeAgingCaveScreen(LargeAgingCaveMenu menu, Inventory playerInventory, Component title) {
