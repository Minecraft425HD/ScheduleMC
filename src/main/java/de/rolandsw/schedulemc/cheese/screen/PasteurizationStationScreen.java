...
import de.rolandsw.schedulemc.cheese.menu.PasteurizationStationMenu;
...
public class PasteurizationStationScreen extends AbstractContainerScreen<PasteurizationStationMenu> {
    public PasteurizationStationScreen(PasteurizationStationMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("block.schedulemc.pasteurization_station"), x + 8, y + 6, 0xFFFFFF, false);
