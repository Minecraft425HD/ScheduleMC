...
import de.rolandsw.schedulemc.cheese.menu.LargeCheesePressMenu;
...
public class LargeCheesePressScreen extends AbstractContainerScreen<LargeCheesePressMenu> {
    public LargeCheesePressScreen(LargeCheesePressMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("block.schedulemc.large_cheese_press"), x + 8, y + 6, 0xFFFFFF, false);
