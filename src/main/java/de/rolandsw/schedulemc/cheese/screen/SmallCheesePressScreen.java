...
import de.rolandsw.schedulemc.cheese.menu.SmallCheesePressMenu;
...
public class SmallCheesePressScreen extends AbstractContainerScreen<SmallCheesePressMenu> {
    public SmallCheesePressScreen(SmallCheesePressMenu menu, Inventory playerInventory, Component title) {
