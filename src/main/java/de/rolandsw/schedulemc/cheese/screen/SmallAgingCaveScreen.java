...
public class SmallAgingCaveScreen extends AbstractContainerScreen<SmallAgingCaveMenu> {
    public SmallAgingCaveScreen(SmallAgingCaveMenu menu, Inventory playerInventory, Component title) {
