package de.rolandsw.schedulemc.cheese.screen;
...
public class PackagingStationScreen extends AbstractContainerScreen<PackagingStationMenu> {
    public PackagingStationScreen(PackagingStationMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        // Slots
        drawSlot(graphics, x + 32, y + 35);  // Wheel input
        drawSlot(graphics, x + 56, y + 35);  // Material input
        drawSlot(graphics, x + 100, y + 35); // Output 1
        drawSlot(graphics, x + 124, y + 35); // Output 2
        ...
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 9; col++) {
                drawSlot(graphics, x + 8 + col * 18, y + 60 + row * 18);
            }
        }
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("block.schedulemc.packaging_station"), x + 8, y + 6, 0xFFFFFF, false);
