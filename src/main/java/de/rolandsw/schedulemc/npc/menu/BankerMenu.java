...
/**
 * Menu für Banker-NPC Interaktion
 * Ermöglicht Banking-Operationen (Einzahlen, Abheben, Überweisen, Transaktionshistorie)
 */
public class BankerMenu extends AbstractContainerMenu {
    ...
    public BankerMenu(int containerId, Inventory playerInventory, CustomNPCEntity npc) {  // NOPMD
        super(NPCMenuTypes.BANKER_MENU.get(), containerId);
        this.npc = npc;
        this.entityId = npc.getId();
    }

    // Client-side constructor
    public BankerMenu(int containerId, Inventory playerInventory, FriendlyByteBuf extraData) {
        super(NPCMenuTypes.BANKER_MENU.get(), containerId);
