...
public class MerchantShopDefaults {
    ...
    private static void setupAutohaendlerShop(NPCData.ShopInventory shop) {
        ...
        shop.addEntry(new NPCData.ShopEntry(new ItemStack(VehicleItems.SPAWN_VEHICLE_OAK.get(), 1), 5000, false, 0));
        shop.addEntry(new NPCData.ShopEntry(new ItemStack(VehicleItems.SPAWN_VEHICLE_BIG_OAK.get(), 1), 7500, false, 0));
        shop.addEntry(new NPCData.ShopEntry(new ItemStack(VehicleItems.SPAWN_VEHICLE_WHITE_TRANSPORTER.get(), 1), 12000, false, 0));
        shop.addEntry(new NPCData.ShopEntry(new ItemStack(VehicleItems.SPAWN_VEHICLE_WHITE_SUV.get(), 1), 10000, false, 0));
        shop.addEntry(new NPCData.ShopEntry(new ItemStack(VehicleItems.SPAWN_VEHICLE_WHITE_SPORT.get(), 1), 15000, false, 0));
    }
}
