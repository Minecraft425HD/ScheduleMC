...
public class MerchantShopDefaults {
    ...
    private static void setupBaumarktShop(ShopInventory shop) {
        ...
        shop.addEntry(new ShopEntry(new ItemStack(Items.GLASS, 16), 40, false, 0));
        ...
        shop.addEntry(new ShopEntry(new ItemStack(Items.GLOWSTONE, 8), 60, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.LADDER, 8), 25, false, 0));
    ...
    private static void setupWaffenhaendlerShop(ShopInventory shop) {
        ...
        shop.addEntry(new ShopEntry(new ItemStack(Items.BOW, 1), 120, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.ARROW, 64), 50, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.IRON_HELMET, 1), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.IRON_CHESTPLATE, 1), 160, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.IRON_LEGGINGS, 1), 140, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.IRON_BOOTS, 1), 80, false, 0));
    ...
    private static void setupTankstelleShop(ShopInventory shop) {
        ...
        shop.addEntry(new ShopEntry(new ItemStack(Items.POWERED_RAIL, 16), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.RAIL, 32), 60, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.BUCKET, 1), 80, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.WATER_BUCKET, 1), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.LAVA_BUCKET, 1), 200, false, 0));
    ...
    private static void setupLebensmittelShop(ShopInventory shop) {
        ...
        shop.addEntry(new ShopEntry(new ItemStack(Items.COOKED_PORKCHOP, 8), 55, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.APPLE, 16), 20, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.GOLDEN_APPLE, 1), 200, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.CARROT, 16), 15, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.POTATO, 16), 15, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.CAKE, 1), 80, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.COOKIE, 32), 25, false, 0));
    }

    private static void setupPersonalmanagementShop(ShopInventory shop) {
        // Werkzeuge & Arbeitsmaterialien - ALLE als Lager-Items (unlimited=false)
        shop.addEntry(new ShopEntry(new ItemStack(Items.IRON_PICKAXE, 1), 120, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.IRON_SHOVEL, 1), 90, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.IRON_HOE, 1), 80, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.SHEARS, 1), 70, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.FISHING_ROD, 1), 60, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.COMPASS, 1), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.CLOCK, 1), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.MAP, 1), 50, false, 0));
    ...
    private static void setupIllegalerHaendlerShop(ShopInventory shop) {
        ...
        shop.addEntry(new ShopEntry(new ItemStack(Items.NETHERITE_SCRAP, 1), 800, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.ENDER_PEARL, 4), 300, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.BLAZE_ROD, 4), 250, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.GHAST_TEAR, 2), 350, false, 0));
    ...
    private static void setupAutohaendlerShop(ShopInventory shop) {
        ...
        shop.addEntry(new ShopEntry(new ItemStack(ModItems.SPAWN_VEHICLE_BIG_OAK.get(), 1), 7500, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(ModItems.SPAWN_VEHICLE_WHITE_TRANSPORTER.get(), 1), 12000, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(ModItems.SPAWN_VEHICLE_WHITE_SUV.get(), 1), 10000, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(ModItems.SPAWN_VEHICLE_WHITE_SPORT.get(), 1), 15000, false, 0));
    }
    ...
    private static void setupPannenhilfeShop(ShopInventory shop) {
    ...
    private static void setupTaxiShop(ShopInventory shop) {
        ...
        shop.addEntry(new ShopEntry(new ItemStack(Items.BREAD, 8), 30, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.WATER_BUCKET, 1), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.LEATHER_BOOTS, 1), 60, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.SADDLE, 1), 250, false, 0));
    }

    private static void setupNotdienstShop(ShopInventory shop) {
        // Notdienst - Medizin & Notfall-Items
        shop.addEntry(new ShopEntry(new ItemStack(Items.GOLDEN_APPLE, 1), 200, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.BREAD, 8), 30, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.COOKED_BEEF, 8), 60, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.POTION, 1), 150, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.TORCH, 32), 20, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.COMPASS, 1), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.WATER_BUCKET, 1), 100, false, 0));
        shop.addEntry(new ShopEntry(new ItemStack(Items.ENDER_PEARL, 4), 300, false, 0));
