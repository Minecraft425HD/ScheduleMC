...
/**
 * GUI für das Große Fermentierungsfass.
 * Identisches Layout wie Small, jedoch mit Rot-Palette.
 */
public class BigFermentationBarrelScreen extends AbstractContainerScreen<BigFermentationBarrelMenu> {

    // Rot-Palette für Big
    private static final int COLOR_PROGRESS  = 0xFFF44336;
    private static final int COLOR_HIGHLIGHT = 0xFFEF9A9A;
    private static final int COLOR_CAPACITY  = 0xFFB71C1C;
    private static final int COLOR_TEXT      = 0xFFF44336;
    ...
    public void render(@NotNull GuiGraphics g, int mouseX, int mouseY, float partialTick) {
        ...
        g.drawString(font,
            Component.translatable("block.schedulemc.big_fermentation_barrel").getString(),
