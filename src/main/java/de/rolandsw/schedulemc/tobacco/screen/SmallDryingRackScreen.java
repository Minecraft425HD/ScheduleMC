...
/**
 * GUI für Small Drying Rack (6 Blätter Kapazität)
 */
public class SmallDryingRackScreen extends AbstractContainerScreen<SmallDryingRackMenu> {

    public SmallDryingRackScreen(SmallDryingRackMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (maxProgress > 0 && progress > 0) {
            ...
            graphics.fill(x + 76, y + 35, x + 76 + progressWidth, y + 51, UIColors.ACCENT_GREEN);
        }
