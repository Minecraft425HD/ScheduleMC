...
/**
 * Mittlerer Packtisch für 10g (Schachteln)
 */
public class MediumPackagingTableBlock extends Block implements EntityBlock {

    public MediumPackagingTableBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new MediumPackagingTableBlockEntity(pos, state);
    }
