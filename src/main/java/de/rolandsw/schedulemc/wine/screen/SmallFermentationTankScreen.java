...
public class SmallFermentationTankScreen extends AbstractContainerScreen<SmallFermentationTankMenu> {

    public SmallFermentationTankScreen(SmallFermentationTankMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.wine.small_fermentation_tank").getString(), x + 8, y + 6, 0xFFFFFF, false);
