...
public class LargeAgingBarrelScreen extends AbstractContainerScreen<LargeAgingBarrelMenu> {

    public LargeAgingBarrelScreen(LargeAgingBarrelMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.wine.large_aging_barrel").getString(), x + 8, y + 6, 0xFFFFFF, false);
