...
public class MediumWinePressScreen extends AbstractContainerScreen<MediumWinePressMenu> {

    public MediumWinePressScreen(MediumWinePressMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.wine.medium_press").getString(), x + 8, y + 6, 0xFFFFFF, false);
