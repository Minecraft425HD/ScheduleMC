...
public class CrushingStationScreen extends AbstractContainerScreen<CrushingStationMenu> {
    ...
    public CrushingStationScreen(CrushingStationMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.wine.crushing_station").getString(), x + 8, y + 6, 0xFFFFFF, false);
