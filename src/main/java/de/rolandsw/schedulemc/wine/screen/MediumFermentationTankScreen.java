...
public class MediumFermentationTankScreen extends AbstractContainerScreen<MediumFermentationTankMenu> {

    public MediumFermentationTankScreen(MediumFermentationTankMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (maxProgress > 0) {
            ...
            if (progressWidth > 0) {
                graphics.fill(x + 76, y + 35, x + 76 + progressWidth, y + 51, 0xFF8B4513); // Wine brown color
            }
        }
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.wine.medium_fermentation_tank").getString(), x + 8, y + 6, 0xFFFFFF, false);
