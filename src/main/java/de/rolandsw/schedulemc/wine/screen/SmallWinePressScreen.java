...
public class SmallWinePressScreen extends AbstractContainerScreen<SmallWinePressMenu> {

    public SmallWinePressScreen(SmallWinePressMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        graphics.drawString(this.font, Component.translatable("gui.wine.small_press").getString(), x + 8, y + 6, 0xFFFFFF, false);
