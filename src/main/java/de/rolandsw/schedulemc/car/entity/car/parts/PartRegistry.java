...
public class PartRegistry {
    ...
    public static final Part ACACIA_BODY = new PartBodyWood(new ResourceLocation(Main.MODID, "textures/entity/car_wood_acacia.png"), "acacia");
    public static final Part DARK_OAK_BODY = new PartBodyWood(new ResourceLocation(Main.MODID, "textures/entity/car_wood_dark_oak.png"), "dark_oak");
    public static final Part BIRCH_BODY = new PartBodyWood(new ResourceLocation(Main.MODID, "textures/entity/car_wood_birch.png"), "birch");
    public static final Part JUNGLE_BODY = new PartBodyWood(new ResourceLocation(Main.MODID, "textures/entity/car_wood_jungle.png"), "jungle");
    public static final Part SPRUCE_BODY = new PartBodyWood(new ResourceLocation(Main.MODID, "textures/entity/car_wood_spruce.png"), "spruce");
    public static final Part CRIMSON_BODY = new PartBodyWood(new ResourceLocation(Main.MODID, "textures/entity/car_wood_crimson.png"), "crimson");
    public static final Part WARPED_BODY = new PartBodyWood(new ResourceLocation(Main.MODID, "textures/entity/car_wood_warped.png"), "warped");
    ...
    public static final Part BIG_ACACIA_BODY = new PartBodyBigWood(new ResourceLocation(Main.MODID, "textures/entity/car_big_wood_acacia.png"), "acacia");
    public static final Part BIG_DARK_OAK_BODY = new PartBodyBigWood(new ResourceLocation(Main.MODID, "textures/entity/car_big_wood_dark_oak.png"), "dark_oak");
    public static final Part BIG_BIRCH_BODY = new PartBodyBigWood(new ResourceLocation(Main.MODID, "textures/entity/car_big_wood_birch.png"), "birch");
    public static final Part BIG_JUNGLE_BODY = new PartBodyBigWood(new ResourceLocation(Main.MODID, "textures/entity/car_big_wood_jungle.png"), "jungle");
    public static final Part BIG_SPRUCE_BODY = new PartBodyBigWood(new ResourceLocation(Main.MODID, "textures/entity/car_big_wood_spruce.png"), "spruce");
    public static final Part BIG_CRIMSON_BODY = new PartBodyBigWood(new ResourceLocation(Main.MODID, "textures/entity/car_big_wood_crimson.png"), "crimson");
    public static final Part BIG_WARPED_BODY = new PartBodyBigWood(new ResourceLocation(Main.MODID, "textures/entity/car_big_wood_warped.png"), "warped");

    public static final Part BLACK_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_black.png"), "black");
    public static final Part BLUE_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_blue.png"), "blue");
    public static final Part BROWN_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_brown.png"), "brown");
    public static final Part CYAN_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_cyan.png"), "cyan");
    public static final Part GRAY_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_gray.png"), "gray");
    public static final Part GREEN_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_green.png"), "green");
    public static final Part LIGHT_BLUE_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_light_blue.png"), "light_blue");
    public static final Part LIME_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_lime.png"), "lime");
    public static final Part MAGENTA_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_magenta.png"), "magenta");
    public static final Part ORANGE_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_orange.png"), "orange");
    public static final Part PINK_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_pink.png"), "pink");
    public static final Part PURPLE_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_purple.png"), "purple");
    public static final Part RED_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_red.png"), "red");
    public static final Part LIGHT_GRAY_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_light_gray.png"), "light_gray");
    ...
    public static final Part YELLOW_SPORT_BODY = new PartBodySport(new ResourceLocation(Main.MODID, "textures/entity/car_sport_yellow.png"), "yellow");

    public static final Part BLACK_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_black.png"), "black");
    public static final Part BLUE_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_blue.png"), "blue");
    public static final Part BROWN_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_brown.png"), "brown");
    public static final Part CYAN_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_cyan.png"), "cyan");
    public static final Part GRAY_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_gray.png"), "gray");
    public static final Part GREEN_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_green.png"), "green");
    public static final Part LIGHT_BLUE_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_light_blue.png"), "light_blue");
    public static final Part LIME_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_lime.png"), "lime");
    public static final Part MAGENTA_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_magenta.png"), "magenta");
    public static final Part ORANGE_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_orange.png"), "orange");
    public static final Part PINK_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_pink.png"), "pink");
    public static final Part PURPLE_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_purple.png"), "purple");
    public static final Part RED_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_red.png"), "red");
    public static final Part LIGHT_GRAY_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_light_gray.png"), "light_gray");
    ...
    public static final Part YELLOW_TRANSPORTER_BODY = new PartBodyTransporter(new ResourceLocation(Main.MODID, "textures/entity/car_transporter_yellow.png"), "yellow");

    public static final Part BLACK_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_black.png"), "black");
    public static final Part BLUE_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_blue.png"), "blue");
    public static final Part BROWN_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_brown.png"), "brown");
    public static final Part CYAN_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_cyan.png"), "cyan");
    public static final Part GRAY_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_gray.png"), "gray");
    public static final Part GREEN_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_green.png"), "green");
    public static final Part LIGHT_BLUE_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_light_blue.png"), "light_blue");
    public static final Part LIME_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_lime.png"), "lime");
    public static final Part MAGENTA_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_magenta.png"), "magenta");
    public static final Part ORANGE_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_orange.png"), "orange");
    public static final Part PINK_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_pink.png"), "pink");
    public static final Part PURPLE_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_purple.png"), "purple");
    public static final Part RED_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_red.png"), "red");
    public static final Part LIGHT_GRAY_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_light_gray.png"), "light_gray");
    ...
    public static final Part YELLOW_SUV_BODY = new PartBodySUV(new ResourceLocation(Main.MODID, "textures/entity/car_suv_yellow.png"), "yellow");
