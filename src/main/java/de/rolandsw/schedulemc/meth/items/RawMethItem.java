...
/**
 * Roh-Meth - Produkt aus ReductionKettle
 * Wird im Crystallizer weiterverarbeitet
 */
public class RawMethItem extends Item {
    ...
    public static ItemStack create(MethQuality quality, int count) {
        ItemStack stack = new ItemStack(MethItems.RAW_METH.get(), count);
