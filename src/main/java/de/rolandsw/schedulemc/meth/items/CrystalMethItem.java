...
/**
 * Kristall-Meth - Produkt aus Crystallizer
 * Wird im Vakuum-Trockner finalisiert
 */
public class CrystalMethItem extends Item {

    public CrystalMethItem() {
    ...
    public static ItemStack create(MethQuality quality, int count) {
        ItemStack stack = new ItemStack(MethItems.CRYSTAL_METH.get(), count);
