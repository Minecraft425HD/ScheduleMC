...
/**
 * Arcade-Style GUI für den ReductionKettle
 ...
 */
public class ReductionKettleScreen extends AbstractContainerScreen<ReductionKettleMenu> {
    ...
    public ReductionKettleScreen(ReductionKettleMenu menu, Inventory playerInventory, Component title) {
